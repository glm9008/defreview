...
namespace DefReview
{
    public partial class FormMain
    {
        ...
        private void createKmvsQueries(BackgroundWorker worker, DoWorkEventArgs e)
        {
            int pc = 1;
            ...
            try
            {
                System.Data.DataTable dt = fetchNesutvarkyti();
        ...
        private string[,] dataTableToStringArray(System.Data.DataTable dataTable)
        {
        ...
        private Dictionary<string, System.Data.DataTable> createDictionary(System.Data.DataTable tblAllRecords)
        {
        ...
        private System.Data.DataTable fetchNesutvarkyti()
        {
            ...
            {
                OleDbCommand cmd = new OleDbCommand();
                cmd.CommandText = string.Format("SELECT Skait, Linija, Kelias, Km, Piketas, Metrai, Siule, Defekto_kodas, Def_pavoing, Aptik_data, TuriButPakeist, Pastaba, Meistrija FROM Defektai WHERE Aptik_data >= #{0:d}# AND FaktPakeistas IS NULL ORDER BY Meistrija", bottomDate);
                cmd.Connection = conn;
                conn.Open();
                using (OleDbDataReader reader = cmd.ExecuteReader())
                {
        ...
        private string vietosKodas (object linija, object kelias, object km, object pk, object m, object siule = null)
        {
            if (siule == null)
            {
